        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">UTF-8 文本与 DNA 序列互转</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            <Button
              variant="outline"
              size="sm"
              onClick={() => window.open("https://github.com/your-username/dna-transcoder", "_blank")}
          ...
          <TabsContent value="encode" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>输入 UTF-8 文本，转换为 DNA 序列</CardDescription>
              </CardHeader>
                    ...
                    <div className="grid gap-4">
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <label className="text-sm font-medium">二进制表示</label>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => copyToClipboard(encodeResults.binary, "二进制")}
                          >
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <label className="text-sm font-medium flex items-center gap-2">
                            DNA 正链
                            <Badge variant="secondary">A=00, T=01, G=10, C=11</Badge>
                          </label>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => copyToClipboard(encodeResults.dnaPositive, "DNA 正链")}
                          >
                            <Copy className="w-4 h-4" />
                          </Button>
                        </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => copyToClipboard(encodeResults.dnaNegative, "DNA 负链")}
                          >
                            <Copy className="w-4 h-4" />
                          </Button>
                        </div>
          ...
          <TabsContent value="decode" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>输入 DNA 序列，转换回 UTF-8 文本</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-2">
                ...
                {decodeResults && (
                  <div className="space-y-4 pt-4 border-t">
                    <div className="grid gap-4">
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <label className="text-sm font-medium">清理后的 DNA 序列</label>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => copyToClipboard(decodeResults.cleanDna, "清理后的 DNA")}
                          >
                            <Copy className="w-4 h-4" />
                          </Button>
                        </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => copyToClipboard(decodeResults.binary, "二进制")}
                          >
                            <Copy className="w-4 h-4" />
                          </Button>
                        </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          <label className="text-sm font-medium">解码文本</label>
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => copyToClipboard(decodeResults.text, "解码文本")}
                          >
                            <Copy className="w-4 h-4" />
                          </Button>
                        </div>
                        <div className="p-3 bg-muted rounded-lg text-sm break-all">{decodeResults.text}</div>
                      </div>
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <Button
                            variant="outline"
                            size="sm"
                            onClick={() => copyToClipboard(decodeResults.complement, "互补链")}
                          >
                            <Copy className="w-4 h-4" />
                          </Button>
                        </div>
